...
%     text(tree.X, tree.Y, ['  ' opText], 'HorizontalAlignment', 'left', 'interpreter', 'none')
    text(tree.X, tree.Y,num2str(tree.dist),'HorizontalAlignment', 'right', 'VerticalAlignment', 'bottom','interpreter', 'none');
else
    line(tree.X, tree.Y, 'marker', '.', 'markersize', 8)
%     text(tree.X, tree.Y, opText, 'HorizontalAlignment', 'center', 'VerticalAlignment', 'top', 'interpreter', 'none')
    text(tree.X, tree.Y, num2str(tree.dist) ,'HorizontalAlignment', 'right', 'VerticalAlignment', 'top', 'interpreter', 'none');
end
